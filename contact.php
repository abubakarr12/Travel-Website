                ...
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        ...
                        <div class="col-lg-5 col-md-6">
                            ...
                            <p class="mb-2"><i class="fa fa-envelope me-3"></i>@ahadking.com</p>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" id="name" placeholder="Your Name" name="username">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control bg-transparent" placeholder="Special Request" id="message" style="height: 100px; " name="message"></textarea>
